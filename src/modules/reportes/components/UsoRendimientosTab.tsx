...
import { KilometrajesActualesModal } from "./KilometrajesActualesModal";
...
const buildKmDiariosData = (res: KilometrosDiariosDto | null): KmRow[] => {
  if (!res) return [];
    ...
    <div className="rounded-lg border border-slate-200 bg-white shadow-md px-3 py-2 text-xs space-y-0.5">
      ...
      <div className="text-slate-600">
        ...
        <span className="font-mono font-semibold text-indigo-700">
          {r.rendimiento !== null
            ? `${r.rendimiento.toLocaleString("es-HN")} km/gal`
            : "—"}
        </span>
      </div>
      <div className="text-slate-600">
        ...
        <span className="font-mono">
          {r.kmRecorridos !== null
            ? r.kmRecorridos.toLocaleString("es-HN")
            : "—"}
        </span>
      </div>
      <div className="text-slate-600">
        Galones:{" "}
        <span className="font-mono">
          {r.galones.toLocaleString("es-HN", {
      ...
      <div className="text-slate-500">
        Lectura:{" "}
        <span className="font-mono">
          {r.kilometraje.toLocaleString("es-HN")}
        </span>{" "}
        km
      </div>
    </div>
...
export const UsoRendimientosTab = () => {
  ...
  const [kmDiarios, setKmDiarios] = useState<KilometrosDiariosDto | null>(null);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="bg-white border border-slate-200 rounded-2xl p-4">
          ...
          <div className="mt-1 text-2xl font-bold text-indigo-700 font-mono">
            {promedioRendimiento !== null
              ? `${promedioRendimiento.toLocaleString("es-HN", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })} km/gal`
              : "—"}
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4">
          ...
          <div className="mt-1 text-2xl font-bold text-emerald-700 font-mono">
            {totalKmMes.toLocaleString("es-HN")}
          </div>
          <div className="text-xs text-slate-500 mt-0.5">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4">
          ...
          <div className="mt-1 text-2xl font-bold text-slate-800 font-mono">
            {promedioKmDia.toLocaleString("es-HN", {
